VERSION 5.00
Begin VB.UserControl GradientClock 
   AutoRedraw      =   -1  'True
   ClientHeight    =   375
   ClientLeft      =   0
   ClientTop       =   0
   ...
   PropertyPages   =   "GradientClock.ctx":0000
   ScaleHeight     =   375
   ScaleWidth      =   360
   ToolboxBitmap   =   "GradientClock.ctx":0014
   ...
   End
End
Attribute VB_Name = "GradientClock"
...
Private Declare Function SetWindowRgn Lib "user32" (ByVal hWd As Long, ByVal hRgn As Long, ByVal bRedraw As Boolean) As Long
...
Private Sub ShowTime()
   ...
   DeleteObject hBrush                                '|                                            |
   Draw_GradientCircle m_ClockBody                    '| Fill with circle gradient style            |
